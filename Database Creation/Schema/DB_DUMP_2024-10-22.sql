...
INSERT INTO `refresh_tokens` VALUES (1,'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjI1LCJpYXQiOjE3Mjk1Njk5NzMsImV4cCI6MTczMDE3NDc3M30.I3eGX_xjUZ4b6SjB8lpsbST3vRiLjtdAD62ztHu2zDw',25,'2024-10-22 04:06:13'),(2,'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjI1LCJpYXQiOjE3Mjk1NzAwMzYsImV4cCI6MTczMDE3NDgzNn0.EJxFMi-MYwGw9bSRM9uuEnrNoMnLejkYocR897bKAd0',25,'2024-10-22 04:07:16'),(3,'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjI1LCJpYXQiOjE3Mjk1NzAyOTksImV4cCI6MTczMDE3NTA5OX0.O1xhskMAmqa59xRhBcsERLSi14RN8WoaSJREEVsWY5E',25,'2024-10-22 04:11:39'),(4,'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjI1LCJpYXQiOjE3Mjk1NzA0NTMsImV4cCI6MTczMDE3NTI1M30.cG0k7LNnYcN9di9eU26MfleMhrHO1V9LFexoFgOGb-4',25,'2024-10-22 04:14:13'),(5,'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjI1LCJpYXQiOjE3Mjk1NzA3MDgsImV4cCI6MTczMDE3NTUwOH0.ikcUQvGuEUBwwFOw0l2y_q9TzWy2tvlDYSiBmmA0ebs',25,'2024-10-22 04:18:28'),(6,'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjI1LCJpYXQiOjE3Mjk1NzA5MzYsImV4cCI6MTczMDE3NTczNn0.orHejOa84J6nbRo8S6-OQrseZTzriWQU0i52MajZolU',25,'2024-10-22 04:22:16'),(7,'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjI1LCJpYXQiOjE3Mjk1NzEyNjksImV4cCI6MTczMDE3NjA2OX0.-PJtOzO5vMU0RW1x7jmVFiQwtU6cwuUmbJ6HBVGBWFc',25,'2024-10-22 04:27:49'),(8,'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjI1LCJpYXQiOjE3Mjk1NzIzNTQsImV4cCI6MTczMDE3NzE1NH0.fGa4bk6iWBj2CxhzltyQLSH0yq8_4fFqIiHXY_kpdZw',25,'2024-10-22 04:45:54'),(9,'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjI1LCJpYXQiOjE3Mjk1NzMwMDMsImV4cCI6MTczMDE3NzgwM30.p_i0CZOXry0iQiRfvQOSDrD42TDU14CS_yq8ZYBSdHs',25,'2024-10-22 04:56:43'),(10,'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjI1LCJpYXQiOjE3Mjk1NzMxMDgsImV4cCI6MTczMDE3NzkwOH0.d1dWyupaVP_LHAGVnJKogd-G5XpWOblMQ8NAzpuqXmo',25,'2024-10-22 04:58:28'),(11,'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjI1LCJpYXQiOjE3Mjk1NzM0ODMsImV4cCI6MTczMDE3ODI4M30.jurJuzXwPdX8EGrgwbPEK91z4Oy4_PqQZaqyYIgD1uU',25,'2024-10-22 05:04:43'),(12,'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjI1LCJpYXQiOjE3Mjk1NzQxNzYsImV4cCI6MTczMDE3ODk3Nn0.Smn19avOdKCorVU6omeqUHqJIHNRmY8qNpUdW7V4rrg',25,'2024-10-22 05:16:16'),(13,'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjI1LCJpYXQiOjE3Mjk1NzQyNzEsImV4cCI6MTczMDE3OTA3MX0.l4EEiRgekJwFaiPxWQ8SYOHdB0TyRaRjAF_I8jV5dkk',25,'2024-10-22 05:17:51'),(14,'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjI1LCJpYXQiOjE3Mjk1NzQ4MTcsImV4cCI6MTczMDE3OTYxN30.nZa1qrOVl_Dt8cbrY8xtERKIx4372N64n8aPE_TP5l4',25,'2024-10-22 05:26:57'),(15,'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjI1LCJpYXQiOjE3Mjk1NzYxMjYsImV4cCI6MTczMDE4MDkyNn0.p60zEbPZ2ibhrtDlEcnWfpyRRP4QGxud-Nj0vCEZYos',25,'2024-10-22 05:48:46'),(16,'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjI1LCJpYXQiOjE3Mjk1NzcyNjIsImV4cCI6MTczMDE4MjA2Mn0.tzHviF1kQBWptyyXzfjYCWdVXF9RxmIU_rZVKrt9sjg',25,'2024-10-22 06:07:42'),(17,'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjI2LCJpYXQiOjE3Mjk1Nzc5MTcsImV4cCI6MTczMDE4MjcxN30.QUS9D88dhr7vpOrEglkOFhcUYl7yfRzCvwuzu6NbAas',26,'2024-10-22 06:18:37');
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `branch_transaction_details` AS select `t`.`transaction_id` AS `transaction_id`,`t`.`account_id` AS `account_id`,`t`.`date` AS `date`,`t`.`amount` AS `amount`,`t`.`transaction_type` AS `transaction_type`,`a`.`account_number` AS `account_number` from (((`transaction` `t` join `account` `a` on((`t`.`account_id` = `a`.`account_id`))) left join `withdrawal` `w` on((`t`.`transaction_id` = `w`.`transaction_id`))) left join `deposit` `d` on((`t`.`transaction_id` = `d`.`transaction_id`))) where ((`w`.`transaction_id` is not null) or (`d`.`transaction_id` is not null)) order by `t`.`date` desc */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2024-10-22 12:06:33
